...
if (isset($_FILES['foto']) && $_FILES['foto']['error'] === UPLOAD_ERR_OK) {
    ...
    if (move_uploaded_file($file_tmp, $upload_path)) {
        ...
        if (!empty($old_foto) && $old_foto !== 'default-avatar.png' && file_exists($upload_dir . $old_foto)) {
...
try {
    ...
    $check_stmt = $pdo->prepare("SELECT COUNT(*) as total FROM admin_lab WHERE email = ? AND id != ?");
