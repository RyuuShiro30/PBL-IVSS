...
<div class="mb-3">
    <label for="role" class="form-label">
        Role Dosen <span class="text-danger">*</span>
    </label>
    <select class="form-select" id="role_lab" name="role_lab" required>
        <option value="">Pilih Role</option>
        <option value="Kepala Lab" <?= ($dosen['role_lab'] ?? '') == 'Kepala Lab' ? 'selected' : '' ?>>Kepala Lab</option>
        <option value="Peneliti" <?= ($dosen['role_lab'] ?? '') == 'Peneliti' ? 'selected' : '' ?>>Peneliti</option>
    </select>
</div>

<div class="mb-3">
    <label for="prodi_dosen" class="form-label">
        Program Studi
    </label>
    <input type="text" class="form-control" id="prodi_dosen" name="prodi_dosen"
           placeholder="Contoh: Teknik Informatika"
           value="<?= htmlspecialchars($dosen['prodi_dosen'] ?? '') ?>">
</div>
