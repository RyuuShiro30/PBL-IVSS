...
if ($role === 'superadmin') {
    $count_stmt = $pdo->query("SELECT COUNT(*) as total FROM logs_lab");
    ...
    $count_stmt = $pdo->prepare("SELECT COUNT(*) as total FROM logs_lab WHERE admin_id = ?");
...
<head>
    ...
    <title>Log Aktivitas - Admin Lab IVSS</title>
