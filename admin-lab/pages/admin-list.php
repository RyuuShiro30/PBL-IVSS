<?php
/**
 * Daftar Admin (Khusus Super Admin)
 * File: pages/admin-list.php
 */
...
// Ambil daftar admin
$pdo = getDBConnection();
$stmt = $pdo->query("SELECT * FROM admin_lab ORDER BY created_at DESC");
...
<head>
    ...
    <title>Kelola Admin - Admin Lab IVSS</title>
